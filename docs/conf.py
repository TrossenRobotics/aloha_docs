...
html_title = "ALOHA Documentation"
...
html_logo = "images/logo_aloha.png"
...
html_context = {
    ...
    'github_repo': 'aloha_docs', # Repo name
...
htmlhelp_basename = 'ALOHADocumentation'
